...
return [
    // Create an aggregate root with multiple existing mirrored referenced and embedded values
    [
        'event' => [
        ...
        'references' => [
            'player' => [
                '@type' => 'honeybee-cmf.projection_fixtures.player',
                    ...
                    [
                        ...
                        'teams' => [
                            [
                                ...
                                'referenced_identifier' => 'honeybee.fixtures.team-5cf33cf1-554b-40be-98e7-ef7b4e98ec8c-de_DE-1',
                                'name' => 'Super Clan'
                            ]
                        ]
                    ]
            ...
            'team' => [
                '@type' => 'honeybee-cmf.projection_fixtures.team',
                'identifier' => 'honeybee.fixtures.team-5cf33cf1-554b-40be-98e7-ef7b4e98ec8c-de_DE-1',
                'revision' => 1,
                'uuid' => '5cf33cf1-554b-40be-98e7-ef7b4e98ec8c',
                'short_id' => 0,
                'language' => 'de_DE',
                'version' => 1,
                'created_at' => '2016-02-26T10:52:37.371793+00:00',
                'modified_at' => '2016-02-26T10:52:37.371793+00:00',
                'workflow_state' => 'edit',
                'workflow_parameters' => [],
                'metadata' => [],
                'name' => 'Super Clan',
