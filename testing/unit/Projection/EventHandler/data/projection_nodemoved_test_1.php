...
return [
    'event_state' => [
        '@type' => 'Honeybee\Tests\Fixtures\GameSchema\Task\TeamNodeMovedEvent',
        'data' => [
            'parent_node_id' => ''
        ],
        'aggregate_root_identifier' => 'honeybee.fixtures.team-d8668418-719e-4c09-886c-c49f45d3ee97-de_DE-1',
        'aggregate_root_type' => 'Honeybee\Tests\Fixtures\GameSchema\Model\Team\TeamType',
    ...
    'subject' => [
        '@type' => 'Honeybee\Tests\Fixtures\GameSchema\Projection\Team\Team',
